/*
	...
	Small changes to stop Visual Studio/ReSharper complaining.
	Jixun Moe
*/
...
private:
	static LPVOID RecurseJumps(LPVOID lpAddr);
	static size_t GetDetourLenAuto(const LPVOID lpStart, JmpType jmpType);
	static void WriteJump(const LPBYTE lpbFrom, const LPBYTE lpbTo);
	static void WriteJump(const LPBYTE lpbFrom, const LPBYTE lpbTo, JmpType jmpType);
	static JmpType GetJmpType(const LPBYTE lpbFrom, const LPBYTE lpbTo);
