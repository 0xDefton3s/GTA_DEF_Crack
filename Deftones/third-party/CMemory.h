...
public:
	...
	public:
		...
		static CMemory GetKernelFunc(const char* func, const char* dllname)
		{

			uintptr_t address2 = (uintptr_t)GetProcAddress(GetModuleHandleA(dllname), func);
